...
class Timeline extends AbstractBlockLayout {
  ...
  public function prepareForm(PhpRenderer $view) {
    ...
    $view->headScript()
      ->appendFile($view->assetUrl('js/timeline-item-pool.js', 'Timeline'));
  }
  ...
  public function prepareRender(PhpRenderer $view) {
    ...
    switch ($library) {
      ...
      default:
        ...
        $view->headLink()
          ->appendStylesheet($view->assetUrl('css/timeline.css', 'Timeline'));
        $view->headScript()
          ->appendFile($view->assetUrl('js/timeline.js', 'Timeline'));
        if ($this->useExternal && !$internalAssets) {
          ...
          $view->headScript()
            ->appendFile($view->assetUrl('vendor/simile/timeline-api/timeline-api.js', 'Timeline'));
          $view->headScript()
            ->appendScript('SimileAjax.History.enabled = false; // window.jQuery = SimileAjax.jQuery;');
        }
        break;
