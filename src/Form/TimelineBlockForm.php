...
class TimelineBlockForm extends Form {
  ...
  public function init() {
    ...
    $argsFieldset->add([
      ...
      'name' => 'title_slide',
      'options' => [
        'label' => 'Use first slide as Title',
        'info' => 'Strongly recommended.',
        'checked_value' => 'yes',
        'unchecked_value' => 'no',
      ],
      'attributes' => [
    ...
    $argsFieldset->add([
      ...
      'options' => [
        'label' => 'Item end date',
        // @translate
        'info' => 'If set, the process will use the other date as a start date.',
        // @translate
        'empty_option' => 'None',
        // @translate
        'term_as_value' => TRUE,
    ...
    $argsFieldset->add([
      ...
      'options' => [
        'label' => 'Render year',
        // @translate
        'info' => 'When a date is a single year, like "1066", the value should be interpreted to be displayed on the timeline.',
        // @translate
        'value_options' => [
          TimelineData::RENDER_YEAR_JANUARY_1 => 'Pick first January',
          // @translate
          TimelineData::RENDER_YEAR_JULY_1 => 'Pick first July',
          // @translate
          TimelineData::RENDER_YEAR_FULL_YEAR => 'Mark entire year',
          // @translate
          TimelineData::RENDER_YEAR_SKIP => 'Skip the record',
          // @translate
        ],
      ],
    ]);
    ...
    $argsFieldset->add([
      ...
      'options' => [
        ...
        'info' => 'Set the default center date for the timeline.' // @translate
          ...
          . ' ' . 'An empty value means "now", "0000-00-00" the earliest date, and "9999-99-99" the latest date.',
        // @translate
      ],
      'validators' => [
        ['name' => 'Date'],
    ...
    $argsFieldset->add([
      ...
      'options' => [
        ...
        'info' => 'Set the default params of the viewer as json, or let empty for the included default.' // @translate
          . ' ' . 'Currently, only "bandInfos" and "centerDate" are managed.',
        // @translate
      ],
      'attributes' => [
        'rows' => 15,
